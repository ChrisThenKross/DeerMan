...
public partial class @InputManager: IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": []
        ...
        m_Player_AddBlud = m_Player.FindAction("AddBlud", throwIfNotFound: true);
    ...
    private readonly InputAction m_Player_AddBlud;
    ...
    public struct PlayerActions
    {
        ...
        public InputAction @AddBlud => m_Wrapper.m_Player_AddBlud;
        ...
        public void AddCallbacks(IPlayerActions instance)
        {
            ...
            @AddBlud.started += instance.OnAddBlud;
            @AddBlud.performed += instance.OnAddBlud;
            @AddBlud.canceled += instance.OnAddBlud;
    ...
    public interface IPlayerActions
    {
        ...
        void OnAddBlud(InputAction.CallbackContext context);
